...
import { productDetailAction,clearError, newReview } from '../../actions/productActions.js';
...
import ListReview from '../review/ListReview.js';
...
const ProductDetail = () =>
{
    ...
    }, [dispatch, alert, error,errorReview, id,success])
    ...
    const reviewHandler = (e) =>
    {
        ...
        //  let reviewObj = {rating,comment,id}
   ...
   <div className="row f-flex justify-content-around">
            ...
            <div className="col-12 col-lg-5 mt-5">
                ...
                <hr />
                            ...
                            <p>Status: <span id="stock_status" className={product.stock > 0 ? 'greenColor' : 'redColor'}>{product.stock > 0 ? 'InStock' : 'outOfStock'}</span></p>
