...
import { getOrderDetail,clearError } from '../../actions/orderAction.js'; 
...
{  
    ...
    console.log(order)
    const { shippingInfo,  paymentInfo,orderItems, user, totalPrice, orderStatus } = order;
    const { id } = useParams();
    useEffect(() =>
    {
                    ...
                    <div className="container container-fluid">
                       <div className="row d-flex justify-content-between">
                            <div className="col-12 col-lg-8 mt-5 order-details">
                                ...
                                <p className="greenColor" ><b className={isPaid ? 'greenColor' : 'redColor'}>{isPaid ? "PAID":"NOT PAID"}</b></p>
